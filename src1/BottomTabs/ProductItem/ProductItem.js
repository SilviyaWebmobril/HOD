                    ...
                    <View style={styles.sectionRow}>
                        ...
                        <View  style={{justifyContent:"flex-end",alignContent:"flex-end",alignItems:"flex-end"}}>
                            ...
                            (this.props.is_added_to_cart !== null
                                ?
                                <IncrementDecrementButton  product_id={this.props.products.id}  quantity={this.props.is_added_to_cart.quantity} price={this.props.products.is_discount == 1 ? this.props.products.new_price : this.props.products.old_price} stock_available={this.props.products.display_stock == 1 ? this.props.products.quantity : 0} />
